...
public class IndexModel : PublicPageModel
{
    ...
    {
        var cacheItem = await _distributedCache.GetOrAddAsync(NemEcommercePublicConsts.CacheKeys.HomeData, async () =>
        {
            ...
            var topSellerProducts = await _productsAppService.GetListTopSellerProductAsync(10);
