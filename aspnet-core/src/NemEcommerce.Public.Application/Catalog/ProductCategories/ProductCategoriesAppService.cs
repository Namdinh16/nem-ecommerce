...
{ 
        ...
        PagedResultRequestDto>, IProductCategoriesAppService
    {
        ...
        {
            var category = await _productCategoryRepository.FirstOrDefaultAsync(x => x.Code == code);
        ...
        {
            var productCategory = await _productCategoryRepository.FirstOrDefaultAsync(x => x.Slug == slug);
