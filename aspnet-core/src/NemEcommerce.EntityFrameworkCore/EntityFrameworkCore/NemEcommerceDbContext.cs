...
public class NemEcommerceDbContext :
    AbpDbContext<NemEcommerceDbContext>,
    IIdentityDbContext,
    ITenantManagementDbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        //{
        //    b.ToTable(NemEcommerceConsts.DbTablePrefix + "YourEntities", NemEcommerceConsts.DbSchema);
