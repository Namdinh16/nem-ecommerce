...
namespace NemEcommerce.Admin.Catalog.Products
{
        ...
        CreateUpdateProductDto>, IProductsAppService
    {
        ...
        public override async Task<ProductDto> UpdateAsync(Guid id, CreateUpdateProductDto input)
        {
            ...
            if (product == null)
                throw new BusinessException(NemEcommerceDomainErrorCodes.ProductIsNotExists);
        ...
        public async Task<ProductAttributeValueDto> AddProductAttributeAsync(AddUpdateProductAttributeDto input)
        {
            ...
            if (attribute == null)
                throw new BusinessException(NemEcommerceDomainErrorCodes.ProductAttributeIsNotExists);
            ...
            switch (attribute.DataType)
            {
                case AttributeType.Date:
                    ...
                    {
                        throw new BusinessException(NemEcommerceDomainErrorCodes.ProductAttributeValueIsNotExists);
                    }
        ...
        public async Task RemoveProductAttributeAsync(Guid attributeId, Guid id)
        {
            ...
            if (attribute == null)
                throw new BusinessException(NemEcommerceDomainErrorCodes.ProductAttributeIdIsNotExists);
            switch (attribute.DataType)
            {
                case AttributeType.Date:
